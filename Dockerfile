...
RUN apt-get install wget git unzip zlib1g-dev libxslt1-dev libcurl4-openssl-dev libicu-dev libldap2-dev graphviz libfreetype6-dev libjpeg62-turbo-dev libpng-dev -y
